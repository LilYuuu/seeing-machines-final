...
public:
    ...
    void drawShadowOnClock(string hand, float rotation, ofFbo fbo, float scale);
    
    float clockRad;
    float hrShadowScale = 1.0;
    float minShadowScale = 1.0;
    float secShadowScale = 1.0;
...
//    ofxCvContourFinder contourFinder_shadow;
    ofxCv::ContourFinder contourFinder_shadow;
